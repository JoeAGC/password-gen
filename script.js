...
let pwLength = prompt('The following series of prompts are to select criteria for your generated password! Please choose a length between 8-128 Characters to get started!')
...
let qryNbrs = confirm('Do you want to use numbers (0-9) for your password?')

let qrySpChars = confirm('Do you want to use special characters (!#$%&\'()*+,-./:;<=>?@[]^_`{|}~) in your password?')
